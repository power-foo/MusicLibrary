...
namespace MusicLibrary.MusicLibraryDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`UserID` = ?) AND ((? = 1 AND `UserName` IS NULL) OR " +
                "(`UserName` = ?)) AND ((? = 1 AND `UserPassword` IS NULL) OR (`UserPassword` = ?" +
                ")))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`UserName`, `UserPassword`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `UserName` = ?, `UserPassword` = ? WHERE ((`UserID` = ?) AND (" +
                "(? = 1 AND `UserName` IS NULL) OR (`UserName` = ?)) AND ((? = 1 AND `UserPasswor" +
                "d` IS NULL) OR (`UserPassword` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MusicLibrary.Properties.Settings.Default.MusicLibraryConnectionString;
        }
        ...
        public virtual int Fill(MusicLibraryDataSet.UsersDataTable dataTable) {
        ...
        public virtual MusicLibraryDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MusicLibraryDataSet.UsersDataTable dataTable = new MusicLibraryDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MusicLibraryDataSet.UsersDataTable dataTable) {
